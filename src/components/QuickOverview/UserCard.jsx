const UserCard = ({ fullName, email, profile }) => {
  return (
    <article className="flex h-20 rounded-md bg-linear-to-b from-zinc-50/50 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.1)] border p-4 items-center primary-border-color gap-5">
